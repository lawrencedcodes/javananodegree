...
class FizzBuzzServiceTest {
	...
	void testBuzzFizz_unclearRepetition() {
		...
		// requirements unclear - does "FizzBuzz" count as a "Fizz" and a "Buzz" as
		// well?
	...
	void testBuzzFizz_boundaryChecking() {
		...
		// how should the program represent that no input produces the output. This
		// example would
		// return the integer -1, which is incorrect. Should we throw an exception,
		...
		// we can also enter invalid occurrence param for "Fizz" or "Buzz", getting back
